...
const initialDrawing: CeilingDrawing = {
  id: "draft-room", objectId: "demo-object", version: 1, createdAt: now, updatedAt: now,
  walls: [
...
export default function ConstructorPage() {
  ...
  function updateSelectedWallLength(value: string) {
    ...
    setDrawing((currentDrawing) => ({ ...currentDrawing, walls: currentDrawing.walls.map((wall) => wall.id === selectedWall.id ? { ...wall, end: next } : wall), version: currentDrawing.version + 1, updatedAt: new Date().toISOString() }));
  }
